 ...
 return (
  <>
    ...
    <div className="w-screen h-screen flex justify-center items-center bg-gradient-to-br from-black via-indigo-900 to-purple-800 animate-gradient bg-[length:300%_200%]">
      <div className="bg-white/10 backdrop-blur-md rounded-2xl h-[80vh] w-[60vh] flex flex-col justify-between shadow-lg border border-white/20">
              <div className="text-white text-center py-2 font-semibold text-lg">
          Users in room: {count}
        </div>
        {/* Message Area */}
        <div className="p-4 space-y-3 overflow-y-auto flex-1">
          {message.map((msgObj, index) => (
            ...
            >
              ...
              <span
                className={`px-5 py-2 rounded-2xl shadow break-words max-w-[75%] ${
                  msgObj.sender === username
        ...
        <div className="flex items-center px-4 py-3 border-t border-white/20">
          <input
            className="flex-1 border border-gray-300 rounded-2xl px-4 py-2 mr-3 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white/60 backdrop-blur-sm placeholder-gray-700"
            placeholder="...type message"
            ref={msgRef}
          />
          <button
            className="bg-blue-500 text-white px-4 py-2 rounded-2xl shadow hover:bg-blue-600 transition"
            onClick={() => {
